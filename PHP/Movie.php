...
class Movie {
    ...
    public function load($id) {
        ...
        $select = $this->bdd->prepare ("SELECT mo.id, mo.title, mo.image, mo.link, mi.synopsis, mi.duration, mi.releaseyear, mi.pegi FROM movies AS mo LEFT JOIN movies_infos AS mi ON mo.id = mi.idMovie WHERE mo.id = $id");
        $select->execute();
