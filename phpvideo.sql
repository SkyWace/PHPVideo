...
--
-- Host: localhost:8889
-- Generation Time: Apr 20, 2023 at 12:08 PM
...
INSERT INTO `users` (`id`, `username`, `firstname`, `surname`, `pwd`, `admin`, `dateCreation`) VALUES
(1, 'Maxime54', 'Maxime', 'Flo', 'max', 1, '2023-04-20'),
(2, 'Lukaviron', 'Luka', 'Da Silva', 'luka', 1, '2023-04-20'),
(3, 'Simon21', 'Simon', 'Delcoque', 'simon', 0, '2023-04-20');
